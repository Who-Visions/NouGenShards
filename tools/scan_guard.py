...
# The user segment is a wildcard: baking one operator's account name in here
# both breaks the guard for everyone else and leaks a home path into a public repo.
ROOT = (
    r"(?:[A-Za-z]:[\\/]+Users[\\/]+[^\\/]+[\\/]+Watchtower"
    r"|/[a-z]/Users/[^/]+/Watchtower"
    r"|/home/[^/]+/Watchtower)"
)
