"""
Generate the Memory Engine long-form essay on the local fleet ($0).
...
PHASES = [
    ("Phase 1: The Reconnaissance (Discovery & Parsing)",
     ["Convergent Traces", "Activate Orchestration", "Deep Grep Latent Structure",
      "Surface Leverage"]),
...
def main():
    sections = ["# The Memory Engine: A 21-Module Anatomy of "
                "Machine Memory\n",
    ...
    for title, modules in PHASES:
        prompt = (
            ...
            f"technical essay titled 'The Memory Engine'. Cover "
