...
`C:\Users\<user>\.codex\memories\local_search_mcp.lock`, producing `PermissionError`
...
Project path:
`C:\Users\<user>\Watchtower\NouGen\NouGenShards`
...
- The wrapper sets `WATCHTOWER_ROOT`, prepends Watchtower to `sys.path`, and runpy-runs
  `C:\Users\<user>\Watchtower\local_search_mcp.py` unchanged.
