...
`C:\Users\super\.codex\memories\local_search_mcp.lock`, producing `PermissionError`
...
Project path:
`C:\Users\super\Watchtower\NouGen\NouGenShards`
...
- The wrapper sets `WATCHTOWER_ROOT`, prepends Watchtower to `sys.path`, and runpy-runs
  `C:\Users\super\Watchtower\local_search_mcp.py` unchanged.
